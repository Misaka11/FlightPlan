...
/**
 * Servlet implementation class AirplanAddServlet
 */
@WebServlet("/AirplanAddServlet")
public class AirplanAddServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AirplanAddServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String ans="success";
        String sql="insert into FLIGHT_PLAN values('"+an1+"','"+an2+"','"+an3+"','"+an4+"','"+an5+"','"+an6+"','"+an7+"','"+an8+"','"+an9+"','"+an10+"','"+an11+"','"+an12+"')";
        try {
            test.query(sql);
        }catch(Exception e)
        {
